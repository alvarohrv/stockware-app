...
Class Cliente extends Crud { //extiende de Crud, por tanto se debe requerir.
    //Los atributos de la clase Producto, tal y como se colocaron en la DB.
    private $id;
    private $nombre;
    private $tipo_documento;
    private $numero_documento;
    private $estado_actor;

    const TABLE = 'cliente'; // El nombre de la tabla en la base de datos
